...
%1 Seite
\section{Sensorik}
Mit das Wichtigste bei einem automatisierten Projekt ist die Sensorik, denn das ist die Grundlage auf der das ganze System basiert. Ohne die richtig gewählte Sensorik ist das Projekt, in unserem Fall die Drohne nicht in der Lage sich zu recht zu Funden und ist quasi blind und somit unbrauchbar. Die Software kann noch so gut sein, jedoch hat auch sie keine Chance, wenn sie zum Beispiel die Drohne richtig zu positionieren soll, ohne die aktuelle Position zu kennen.\\
...
\begin{figure}[h]
	...
	\caption{Ultraschallsensor Schaubild\\Quelle: https://tutorials-raspberrypi.de/entfernung-messen-mit-ultraschallsensor-hc-sr04/}
...
\begin{figure}[h]
	...
	\caption{Raspberry Pi Camera Module an einen Raspi angeschlossen \\Quelle: https://www.raspberrypi.org/products/camera-module-v2/}
	\label{fig:meine-grafik}
\end{figure}
\\
...
\begin{itemize}
	\item Greifen eines 10mm x 10mm x 10mm großen Pakets
...
\begin{figure}[h]
	...
	\caption{Elektrischer Hubzylinder \\Quelle: https://www.cti-modellbau.de/CTI-Hubzylinder/titan/}
	\label{fig:meine-grafik}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.4]{"Grafiken/pixhawk2.png"}
	\caption{Flight Controller Pixhawk 2 \\Quelle: https://docs.px4.io/v1.9.0/en/flight\_controller/pixhawk-2.html}
	\label{fig:meine-grafik}
\end{figure}
\\
\\
